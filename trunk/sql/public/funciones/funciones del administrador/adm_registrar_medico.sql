...
BEGIN
	...
	IF NOT EXISTS (SELECT 1 FROM usuarios_administrativos WHERE log_doc = _log_doc) THEN     		
...
--SELECT adm_registrar_medico(ARRAY['Lisseth', 'Lozada', '123', 'llozada2','04269150722']);
