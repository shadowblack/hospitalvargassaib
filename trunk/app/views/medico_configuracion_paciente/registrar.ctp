...
function() { jQuery(this).removeClass('ui-state-hover'); }
    ...
    <div id="tabs">
        <ul>
            <li>
                <a href="#tabs-1">Nuevo Paciente</a>
            </li>
            
            <li>
                <a href="#tabs-2">Evaluación Consulta</a>
            </li>
            
            <li>
                <a href="#tabs-3">Evolución Tratamiento</a>
            </li>
            
            <li>
                <a href="#tabs-4">Muestra Clinica</a>
            </li>
        </ul>
        ...
        <legend>
            <strong>
             ...
             <form id="for_Pac" name="for_Pac" method="post" action="null" onSubmit="return false">
                <table width="540" border="0" align="center" bgcolor="" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="184">Nombre</td>
                    <td width="9">&nbsp;</td>
                    <td width="189">Apellido</td>
                    <td width="8">&nbsp;</td>
                    <td width="144">Cedula de Identidad</td>
                  </tr>
        ...
        <legend>
             ...
             <form id="for_Eva" name="for_Eva" method="post" action="">
                ...
                <table width="100" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td style="font-size: 12px;"><div align="right">Especifique:</div></td>
                    <td>
            ...
            <strong>
             ...
             <form id="for_Tra" name="for_Tra" method="post" action="">    
                ...
                <table width="443" border="0" cellpadding="0" cellspacing="0" align="center">
                  ...
                  <tr>
                    <td style="font-size: 12px;">
                        <div align="right">Hormonas sexuales</div>        
                    </td>
