            ...
            <tr>    
                <td class="">
                    <div style="margin-left: 25px;">
                        <input type="checkbox" name="chk_par_cue" id_par_cue_cat_cue="<?php echo $row->id_par_cue_cat_cue?>" class="standar_input_checkbox" onclick="check_lesion(this);" value="<?php echo $row->id_par_cue?>">
