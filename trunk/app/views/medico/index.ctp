                    ...
                    <td align="right">                                        
                        <div class="dock" id="dock">
                            <div class="dock-container">
                                ...
                                <a class="dock-item" href="<?php echo $this->Html->url("/MedicoMenu/estadistica");?>" target="men_izq_reg"><img style="padding-left: 60px;" src="<?php echo $this->webroot?>/js/men_mac/images/estadistica.png" alt="Estadistica" /><span style="padding-left: 60px;"><?php print __('Estadistica', true); ?></span></a>
