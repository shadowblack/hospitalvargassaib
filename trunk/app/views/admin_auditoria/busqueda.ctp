...
<div id="tabs-1" style="display: none;">    		
    <div id="tabs">
        ...
        <fieldset style="" class="standar_fieldset_content">
            <form method="post" action="<?php echo $this->Html->url("/AdminAuditoria/event_listar")?>" name="frmBusqueda" id="frmBusqueda" onsubmit="return Validar()"> 
                		...
                		<tr>
                			<td>
                				<table align="center" border="0" width="100%" cellpadding="0" cellspacing="0">
                						...
                						<td align="left">
                                            ...
                                            <?php 
                                                  foreach($usuarios as $row){?>   
                                                    <option value="<?php echo $row->id_tip_usu_usu;?>" title="<?php echo $row->nom_ape_usu;?>"><?php echo $row->nom_ape_usu;?></option>
                                            <?php }?>
                							</select>
                						</td>
                                    ...
                                    <tr>                                    
                                        <td align="right" class="font-standar" valign="top" style="margin-right: 5px;" >
                							<?php print __('Tipo de Usuarios', true); ?>:
                                        </td>
                                        <td valign="top">
                                            <select id="sel_tip_usu" name="sel_tip_usu" class="required" style="width: 120px;">
                                                <?php foreach($tipo_usuario as $row){?>   
                                                        <option value="<?php echo $row->id_tip_usu;?>" title="<?php echo $row->des_tip_usu;?>"><?php echo $row->des_tip_usu;?></option>
                                                <?php }?>
                                            </select>
                                        </td>
                					</tr>
