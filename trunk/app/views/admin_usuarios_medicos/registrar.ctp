                            ...
                            <table style='width:483px' border="0" align="center">
                                <tr>
                                    <td class="tam_cel" valign="top">
                                         <label for="nom_usu_doc"  class="standar_font"><span class="standar_asterisco">*</span><?php echo __("Nombre");?>:</label>
                        			     <input type="text" id="nom_usu_doc" name="nom_usu_doc" class="text required" minlength="3" maxlength="100" />
                                    </td>
                                    <td class="tam_cel" valign="top">    
                                         <label for="ape_usu_doc" class="standar_font"><span class="standar_asterisco">*</span><?php echo __("Apellido");?>:</label>
                                ...
                                <tr>
                                    <td valign="top">
                                        ...
                                        <input type="text" id="ced_usu_doc" name="ced_usu_doc" class="number required" minlength="6" maxlength="8" />
                                    </td>
                                    <td valign="top">
                                         <label for="log_usu_doc"  class="standar_font"><span class="standar_asterisco">*</span><?php echo __("Usuario");?>:</label>
                        			     <input type="text" id="log_usu_doc" name="log_usu_doc" class="text required" minlength="3" maxlength="100" />
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top">
                                         <label for="pas_usu_doc"  class="standar_font"><span class="standar_asterisco">*</span><?php echo __("Clave");?>:</label>
                                ...
                                <tr>
                                    <td valign="top">    
                                         <label for="rep_pas_usu_doc" class="standar_font"><span class="standar_asterisco">*</span><?php echo __("Repetir Clave");?>:</label>
                        			     <input type="password" id="rep_pas_usu_doc" name="rep_pas_usu_doc" class="required" minlength="3" maxlength="100" />
                                    </td>                                
                                    <td valign="top">    
                                         <label for="tel_usu_doc" class="standar_font"><span class="standar_asterisco">*</span><?php echo __("Teléfono");?>:</label>
                                ...
                                <tr>
                                    <td valign="top">
                        			     ...
                        			     <input type="text" id="cor_usu_doc" name="cor_usu_doc" class="email required" minlength="10" maxlength="100" />
                                    </td>
