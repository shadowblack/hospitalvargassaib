    ...
    <div id="tabs">
        <ul>
            <li>
                <a href="#tabs-1">Tipo de Infección</a>
            </li>
            <li>
                <a href="#tabs-2">Descripción de la Lesi&oacute;n I</a>
            </li>
            <li>    
                <a href="#tabs-3">Descripción de la Lesi&oacute;n II</a>
            </li>
            <li>
                <a href="#tabs-4">Estudio Micológico</a>
            </li>
		</ul>
...
<!--FIN DE LA PRIMERA PESTAÑA DEL MODULO MICOSIS SUPERFICIAL--> 
    ...
    <form id="for_Eva" name="for_Eva" method="post" action="">
        <table width="503" border="0" align="center" cellpadding="0" cellspacing="0" >
            ...
            <tr>
                ...
                <td width="80"><div align="center">Mano</div></td>
                <td width="80"><div align="center">U&ntilde;as</div></td>
                <td width="80"><div align="center">Pies</div></td>
            </tr>
        </table>
        ...
        <table width="503" border="0" align="center" cellpadding="0" cellspacing="0" >
            <tr>
                <td width="20">&nbsp;</td>
                <td width="152">&nbsp;</td>
                <td width="40"><div align="center">Izq</div></td>
                <td width="40"><div align="center">Der</div></td>
                <td width="40"><div align="center">Izq</div></td>
                <td width="40"><div align="center">Der</div></td>
                <td width="40"><div align="center">Izq</div></td>
                <td width="40"><div align="center">Der</div></td>
    ...
    <table width="503" border="0" align="center" cellpadding="0" cellspacing="0" >
      <tr>
        ...
        <td width="141">Onicolisis subungueal distal</td>
        <td width="13">&nbsp;</td>
        <td width="40"><div align="center"><img src="../img/Img_formulario/Man_Izq.png" height="47" width="41"/></div></td>
        <td width="40"><div align="center"><img src="../img/Img_formulario/Man_Der.png" height="47" width="41"/></div></td>
        <td width="40"><div align="center"><img src="../img/Img_formulario/Una_Izq.png" height="47" width="41"/></div></td>
        <td width="40"><div align="center"><img src="../img/Img_formulario/Una_Izq.png" height="47" width="41"/></div></td>
        <td width="40"><div align="center"><img src="../img/Img_formulario/Pie_Izq.png" height="47" width="41"/></div></td>
        <td width="40"><div align="center"><img src="../img/Img_formulario/Pie_Izq.png" height="47" width="41"/></div></td>
        </tr>
      <tr>
        <td><p>
 ...
 <!--Inicio de la 1ra fila-->  
        <tr>
            ...
            <td width="220"> 
                <div align="left">Multiples</div></td>
        </tr>
<!--Fin de la 1ra fila-->        
...
<!--Fin de la 6ta fila-->
    ...
    <table width="283" border="1" align="center" cellpadding="0" cellspacing="0">
