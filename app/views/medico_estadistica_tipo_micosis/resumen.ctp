...
<table  width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
	<tr>
		<td>
			<table border="1" style="border-collapse: inherit;" style="border-collapse: inherit;" align="center" cellpadding="0" cellspacing="0" width="90%">
                <tr>
								...
								if (count($tip_mic) > 0)
								{
									...
									{	
        								...
        								<tr class="celda_blanco_text_azul" >
                                            <td class="standar_font" align="left"><?php echo $row->nom_tip_mic;?></td>
