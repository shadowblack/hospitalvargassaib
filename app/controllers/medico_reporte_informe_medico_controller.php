<?php
    class MedicoReporteInformeMedicoController extends Controller{
        var $name = "MedicoReporteInformeMedico";
        ...
        function busqueda(){
            ...
            $title = __("Buscar Informe médico",true);
