...
FECHA DE MODIFICACIÓN: 04/02/2012
SIGIS. C.A
-----------------------------------------------------------------------------------------------
*/
?>		
...
<div id="tabs-1" style="display: none;">    		
    <div id="tabs" style="overflow-y: auto;overflow-x:hidden ;">
        <ul>
            <li>
                <a href="#tabs-1" style="width: 685px;">
                   <?php print __('Listado de Transacciones', true); ?>
                </a>
            </li>            
        </ul>
            								...
            								if (count($auditoria) > 0)
            								{
            									...
            									{										
                    								...
                    								<tr class="celda_blanco_text_azul" >
                										...
                										{
                                                        ?>
                                                        <a class="texto_link" href="javascript:visualizarDetalle('<?php print ($i);?>',450,350);" title="<?php  print __('Generar Reporte de Auditoría',true);?>">
