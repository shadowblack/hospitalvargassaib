...
PARÁMETROS: (ningunos)
DESCRIPCIÓN: página de búsqueda para visualizar el informe medico.
...
<div id="tabs-1" style="display: none;">    		
    <div id="tabs">
        ...
        <fieldset style="" class="standar_fieldset_content">
            <form method="post" action="<?php echo $this->Html->url("/MedicoReporteInformeMedico/event_listar")?>" name="frmBusqueda" id="frmBusqueda" onsubmit="return Validar()"> 
